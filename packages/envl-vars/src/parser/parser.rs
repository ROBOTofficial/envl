...
use crate::{
    ...
    parser::error::{
        ...
        COLON_REQUIRED, COMMA_POSITION, COMMA_REQUIRED, DIFFERENT_ORDER, INVALID_ARRAY_POSITION,
        ITEM_NAME_NOT_SET, STRUCT_AFTER_EQUAL, STRUCT_CLOSED, STRUCT_INVALID_CLOSE,
        SYNTAX_IN_STRUCT,
    },
};
